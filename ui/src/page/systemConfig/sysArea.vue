        ...
        <div class="prd-menu-container" :style="{height: containerHeightNum + 'px'}">
            ...
            <div class="prd-menu-container-right">
                ...
                <el-table :data="pagination.content" :height="heightNum" highlight-current-row v-loading="isLoading" border>
                    ...
                    <el-table-column prop="cityId" label="市ID(气象局)" width="100"></el-table-column>
                    <el-table-column prop="latitude" label="维度" width="100"></el-table-column>
                    ...
                    <el-table-column label="操作" min-width="150" fixed="right">
                        <template slot-scope="scope">
                            ...
                            <el-button @click="changeStatus(scope.$index, scope.row)" type="warning">{{scope.row.status==0 ? '禁用' : '启用'}}</el-button>
                        </template>
                    </el-table-column>
                </el-table>
    ...
    export default {
        ...
        methods: {
            handleNodeClick(data) {
                ...
                http.get("api/sysArea/", {params: params}).then(response => {
            ...
            loadPagination() {
                ...
                self.isLoading = true;
                http.get("api/sysArea/query", {params: params}).then(response => {
            ...
            changeStatus(index, row) {
                ...
                let url = "api/sysArea/" + row.id + "/" + status;
